...
public class Constants {
    ...
    public static final String CHOSEN_CATEGORY= "Workshops";
    public static final String EVENT_DATE ="12/26/2025";
    public static final String EVENT_START_TIME = "17:00";
    public static final String EVENT_END_TIME = "19:00";
    public static final String VENUE_NAME = "TBC CONCEPT SPACE";
    public static final String CITY = "Tbilisi";
    public static final String ADDRESS = "მარჯანიშვილის ქუჩა 7";
    public static final String FLOOR = "IV სართული";
    public static final String ROOM_NUMBER = "444";
    public static final String MAX_CAPACITY = "404";
    ...
    public static final String EVENT_NAME = "Cybersecurity Essentials";
    public static final String FOUND_EVENT_URL ="http://34.52.231.181:4201/events/108";
